<template>
  ...
  >
    <v-list>
      ...
      <v-list-item link color="primary" :to="'/admin/drzave'">
        <v-list-item-action class="mr-6">
          <v-icon :size="24">mdi-animation</v-icon>
        </v-list-item-action>
        <v-list-item-content>
          <v-list-item-title link> Drzave </v-list-item-title>
        </v-list-item-content>
      </v-list-item>

      <v-list-item link color="primary" :to="'/admin/osebe'">
        <v-list-item-action class="mr-6">
          <v-icon :size="24">mdi-animation</v-icon>
        </v-list-item-action>
        <v-list-item-content>
          <v-list-item-title link> Osebe </v-list-item-title>
        </v-list-item-content>
      </v-list-item>

      <v-list-item link color="primary" :to="'/admin/postne_stevilke'">
        <v-list-item-action class="mr-6">
          <v-icon :size="24">mdi-animation</v-icon>
        </v-list-item-action>
        <v-list-item-content>
          <v-list-item-title link> Postne stevilke </v-list-item-title>
        </v-list-item-content>
      </v-list-item>
