...
export default {
  ...
  computed: {
    ...mapState({
        ...
        optionsPoste_stevilke_id: state => state.osebeForm.searchResultPoste_stevilke_id,
    ...
    async submitHandler() {
        ...
        data.poste_stevilke_id = this.poste_stevilke_id
                ...
                const poste_stevilke_idEl = this.optionsPoste_stevilke_id.filter(i => i.label === this.poste_stevilke_id)
                data.poste_stevilke_id = poste_stevilke_idEl.length ? poste_stevilke_idEl[0].id : null
        ...
        formatData() {
            ...
            this.poste_stevilke_id = dataFormatter.postne_stevilkeOneListFormatter(this.data.poste_stevilke_id)
