<template>
  <div>
    ...
    >
      ...
      <template v-slot:item.id_drzave="{ item }">
        <span>
          {{ dataFormatter.drzaveOneListFormatter(item.id_drzave) }}
        </span>
      </template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        modal: false,
        headers: [
          { text: 'Poštna številka', value: 'postna_stevilka' },
          { text: 'Kraj', value: 'kraj' },
          { text: 'Država', value: 'id_drzave' },
          { text: 'Actions', value: 'actions', sortable: false },
        ],
        showFilters: false,
        filters: [
          { label: 'Poštna številka', title: 'postna_stevilka' },
          { label: 'Kraj', title: 'kraj' },

          { label: 'Država', title: 'id_drzave' },
        ],
        options: {},
      };
    },
