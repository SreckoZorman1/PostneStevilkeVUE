  ...
  export default {
    ...
    data() {
      return {
        ...
        showFilters: false,
        filters: [
          { label: 'drzava_lokalno', title: 'drzava_lokalno' },
          { label: 'oznaka_drzave', title: 'oznaka_drzave' },
          { label: 'drzava_iso', title: 'drzava_iso' },
          { label: 'opombe', title: 'opombe' },
        ],
        options: {},
      };
    },
