  ...
  export default {
    ...
    methods: {
      ...
      async submitHandler() {
        ...
        data.drzava_slo = this.drzava_slo;

        data.drzava_iso = this.drzava_iso;

        data.oznaka_dvomestna = this.oznaka_dvomestna;

        data.oznaka_tromestna = this.oznaka_tromestna;
      ...
      formatData() {
        this.drzava_slo = this.data.drzava_slo;

        this.drzava_iso = this.data.drzava_iso;

        this.oznaka_dvomestna = this.data.oznaka_dvomestna;

        this.oznaka_tromestna = this.data.oznaka_tromestna;
      },
    },
    async beforeMount() {
      try {
