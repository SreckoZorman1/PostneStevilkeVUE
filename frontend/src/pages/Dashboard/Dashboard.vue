              ...
              <v-card class="">
                ...
                <v-card-text class="pa-5 pt-0">
                  ...
                  <v-row class="d-flex">
                    ...
                    <v-col cols="3"><span class="text-h3" v-text="drzave"></span></v-col>
                  </v-row>
              ...
              <v-card class="">
                ...
                <v-card-text class="pa-5 pt-0">
                  ...
                  <v-row class="d-flex">
                    ...
                    <v-col cols="3"><span class="text-h3" v-text="osebe"></span></v-col>
                  </v-row>
              ...
              <v-card class="">
                ...
                <v-card-text class="pa-5 pt-0">
                  ...
                  <v-row class="d-flex">
                    ...
                    <v-col cols="3"><span class="text-h3" v-text="postne_stevilke"></span></v-col>
                  </v-row>
...
export default {
    data() {
      return {
       users: 0, drzave: 0, osebe: 0, postne_stevilke: 0,
      };
    },
    created() {
      const fetchData = async () => {
         const { data: { count: users } } = await axios.get('/users/count');
         const { data: { count: drzave } } = await axios.get('/drzave/count');
         const { data: { count: osebe } } = await axios.get('/osebe/count');
         const { data: { count: postne_stevilke } } = await axios.get('/postne_stevilke/count');

         this.users = users; this.drzave = drzave; this.osebe = osebe; this.postne_stevilke = postne_stevilke;
      };
      fetchData();
    },
  computed: {
